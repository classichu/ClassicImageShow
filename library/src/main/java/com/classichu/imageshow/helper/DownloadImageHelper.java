...
import com.classichu.imageshow.tool.DateTool;
import com.classichu.imageshow.tool.MediaFileTool;
import com.classichu.imageshow.tool.SdcardTool;
import com.classichu.imageshow.tool.ThreadTool;
...
public class DownloadImageHelper {
    ...
    // 获得存储卡的路径
    private static String sd_path = SdcardTool.getSDCardPath();
