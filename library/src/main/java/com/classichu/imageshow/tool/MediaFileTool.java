...
public class MediaFileTool {
    ...
    public static String getExtensionByMimeType(String mimeType,boolean isUpperCase,boolean withDot){
        String extension="";
        int fileType= getFileTypeForMimeType(mimeType);
        for (String key : sFileTypeMap.keySet()) {
           // System.out.println("key= "+ key + " and value= " + map.get(key));
            MediaFileType mediaFileType=sFileTypeMap.get(key);
            if (mediaFileType.mimeType.equals(mimeType)){
                extension=key;
                break;
            }
        }
    ...
    public static String  getExtensionByMimeType(String mimeType){
        return  getExtensionByMimeType(mimeType,false,false);
    }
